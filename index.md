...
- Testing, verification and repair of AI or AI-based systems, e.g., large language models (LLMs), deep neural networks, autonomous cars;
- Safety of LLMs or LLM-based systems;
