...
In general, my research goal is to *develop principled methodologies towards building more trustworthy AI models/applications/systems and more secure systems*. I am particularly interested in software engineering for AI and formal methods applied to security, covering the following research topics:
...
- Formal reasoning of security (see [TSE 2021](https://ieeexplore.ieee.org/document/8576657), [CCS 2023](https://dl.acm.org/doi/abs/10.1145/3576915.3616609), [ICSE 2025](https://www.computer.org/csdl/proceedings-article/icse/2025/056900a734/251mHfUjxMk), [WWW 2025](https://dl.acm.org/doi/abs/10.1145/3696410.3714682), etc);
