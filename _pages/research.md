...
> Formally modelling a complex CPS is extremely challenging, can we automatically learn and verify a system without manual modelling?
...
- [[TSE 2018](https://ieeexplore.ieee.org/abstract/document/8576657/)] Proposed a CEGAR-style abstraction-based learning framework to push forward learning to be applicable for large-scale systems with infinite state space.
...
## Software Engineering for Trustworthy Artificial Intelligence

> Artificial Intelligence is deeply interwined with software engineering. While AI can be intrinsically vulnerable/discriminative to be trusted, software engineering could help either by testing or formal verification.


### Series of Works
- [[ICSE 2019](https://arxiv.org/pdf/1812.05793.pdf)] Proposed a runtime detection system framework to filter adversarial samples of deep neural networks. Compared to existing detection algorithms, it is sufficiently efficient to be applicable at runtime.
